            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Welcome, {{ auth()->user()->manager_operasional->name }}</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchPerformanceData(period) {
                fetch(`/manager-operasional/dashboard-manager-operasional/chart-performance?period=${period}`)
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchChartData(period) {
                fetch(`/manager-operasional/dashboard-manager-operasional/chart-paket?period=${period}`)
                    .then(response => response.json())
                    .then(data => {
                        if (salesChart) {
                            salesChart.destroy();
